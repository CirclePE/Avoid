...
public class Attacker extends ShapeBase
{
    ...
    public Attacker(float x,float y,float width,float height)
    {
        vertices = new float[]{
                x      ,y+height,0,
                x+width,y+height,0,
    ...
    public Attacker(float x,float y,float width,float height,float[] color)
    {
        vertices = new float[]{
                x      ,y+height,0,
                x+width,y+height,0,
